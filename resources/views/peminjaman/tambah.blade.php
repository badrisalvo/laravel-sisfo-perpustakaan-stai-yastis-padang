...
@section('judul')
    <h2 class="text-yellow"><b>Form Peminjaman Buku</b></h2>
@endsection
        ...
        <div class="card-body">
            ...
            <form action="/peminjaman" method="POST">
                ...
                <div class="form-group">
                    <label for="nama" class="text-black font-weight-bold">Nama Peminjam</label>
                ...
                <div class="fom-group">
                    <label for="buku" class="text-black font-weight-bold">Buku yang akan dipinjam</label>
