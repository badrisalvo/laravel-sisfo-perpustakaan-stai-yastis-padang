...
@section('judul')
    <h2 class="text-yellow">Detail Kategori</h2>
@endsection

@section('content')
    <div class="card">
        <h3 class="judul m-3 text-black" style="font-weight:bold;">{{ $kategori->nama }}</h3>
    ...
    <h4 class="m-3 text-yellow" style="font-weight: bold;">Buku Terkait Kategori :</h4>
        ...
        <div class="row d-flex flex-wrap justify-content-center">
            ...
            @forelse ($kategori->kategori_buku as $item)
                <div class="col-auto my-2" style="width:18rem;">
                    <div class="card mx-2 my-2" style="min-height:15rem;">
